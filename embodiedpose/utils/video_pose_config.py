from copycat.utils.config_utils.base_config import Base_Config
...
class Config(Base_Config):
    ...
    def __init__(self, **kwargs):
        ...
        # Policy Specs
        self.policy_name = self.policy_specs.get("policy_name",
                                                 "kin_net_humor")
        ...
        self.cc_cfg = self.cfg_dict.get("cc_cfg", "copycat_e_1")
        self.cc_cfg = CC_Config(cfg_id=self.cc_cfg, base_dir="../Copycat/")
