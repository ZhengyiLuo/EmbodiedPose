...
3. Download and install Universal Humanoid Controller Locally and follow the instructions to setup the data and download the models. **❗️❗️❗️Make sure you have UHC running locally before proceeding**:
